class Scenario:
    ...
    def __init__(self, id, radius_of_interest, radius_of_replication, radius_of_persistence, max_area, user_generation_distribution, speed_distribution,pause_distribution,min_pause,max_pause,
    min_speed,max_speed,delta,radius_of_tx,usr_list,channel_rate,num_users,min_flight_length, max_flight_length,flight_length_distribution, hand_shake):
    ...
    def displayScenario(self):
        print("Scenario ID: ", self.id, "Radius of interest : ", self.radius_of_interest,  ", Radius of replication: ", self.radius_of_replication, 
              ...
              ", Radious of tx: ", self.radius_of_tx, ", Users List: ", self.usr_list, ", Mbs: ", self.mbs, ", Used Mbs: ", self.used_mbs, 
